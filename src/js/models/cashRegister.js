...
/**
 * Cria uma caixa registadora detalhada com teclado colorido, impressora e displays.
 * @returns {THREE.Group} O grupo contendo a caixa registadora.
 */
export function createCashRegister() {
    const group = new THREE.Group();

    // Helper para criar materiais Standard (PBR)
    const mat = (color, rough = 0.55, metal = 0.05) =>
    ...
    // Helper: cria uma caixa e adiciona ao grupo
    ...
    // ── Bloco traseiro (base da impressora) ─────────────────────
