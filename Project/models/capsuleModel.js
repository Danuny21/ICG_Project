...
export function criarCapsula() {
    ...
    const bottomGeo = new THREE.SphereGeometry(2, 12, 8, 0, Math.PI * 2, Math.PI / 2, Math.PI / 2);
    const topGeo = new THREE.SphereGeometry(2, 12, 8, 0, Math.PI * 2, 0, Math.PI / 2);
